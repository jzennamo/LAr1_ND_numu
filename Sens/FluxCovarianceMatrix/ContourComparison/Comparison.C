...
//=========  (Mon Jan  6 15:48:30 2014) by ROOT version5.34/05
   ...
   gROOT->ProcessLine(".x ./Sens_Matrix_LAr1ND_100m_T600_off_axis_Shape_and_Rate.C(c3)");
   gROOT->ProcessLine(".x ./Sens_Matrix_LAr1ND_150m_T600_off_axis_Shape_and_Rate.C(c3)");
   gROOT->ProcessLine(".x ./Sens_Matrix_LAr1ND_200m_T600_off_axis_Shape_and_Rate.C(c3)");
   ...
   TLegendEntry *entry=leg->AddEntry(gdummy3,"LAr1-ND (100m), T600 (off axis): 90% CL","l");
   TLine *gdummy3 = new TLine();
   gdummy3->SetLineColor(kRed-3);
   gdummy3->SetLineStyle(1);
   gdummy3->SetLineWidth(2);
   TLegendEntry *entry=leg->AddEntry(gdummy3,"LAr1-ND (150m), T600 (off axis): 90% CL","l");
   TLine *gdummy3 = new TLine();
   gdummy3->SetLineColor(kBlue-3);
   gdummy3->SetLineStyle(1);
   gdummy3->SetLineWidth(2);
   TLegendEntry *entry=leg->AddEntry(gdummy3,"LAr1-ND (200m), T600 (off axis): 90% CL","l");
