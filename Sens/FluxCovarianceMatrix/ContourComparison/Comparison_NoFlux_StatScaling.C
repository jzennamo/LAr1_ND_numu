...
//=========  (Mon Jan  6 15:48:30 2014) by ROOT version5.34/05
   ...
   hr1__1->GetZaxis()->SetLabelFont(62);
   hr1__1->GetZaxis()->SetLabelSize(0.035);
   hr1__1->GetZaxis()->SetTitleSize(0.035);
   hr1__1->GetZaxis()->SetTitleFont(62);
   hr1__1->Draw("");

   TLatex *tex_show = new TLatex(.55,.92,"Relative Sensitivity Comparison");
   tex_show->SetNDC();
   ...
   TLatex *tex_pre = new TLatex(.55,.72,"PRELIMINARY");
   tex_pre->SetNDC();
   ...
   TLatex *tex_sca = new TLatex(.55,.76,"ND Stats. Scaled to 100m");
   tex_sca->SetNDC();
   ...
   TLatex *tex_mode = new TLatex(.55,.89,"#nu mode, CC Events");
   tex_mode->SetNDC();
   tex_mode->SetTextFont(62);
   tex_mode->SetTextSize(0.025);
   tex_mode->Draw();

   TLatex *tex_un = new TLatex(.55,.86,"Statistical Uncertainty Only");
   tex_un->SetNDC();
   tex_un->SetTextFont(62);
   tex_un->SetTextSize(0.025);
   tex_un->Draw();

   TLatex *tex_E = new TLatex(.55,.83,"Reconstructed Energy");
   tex_E->SetNDC();
   tex_E->SetTextFont(62);
   tex_E->SetTextSize(0.025);
   tex_E->Draw();

   TLatex *tex_eff = new TLatex(.55,.8,"80% #nu#lower[0.4]{#mu} Efficiency");
   tex_eff->SetNDC();
   tex_eff->SetTextFont(62);
   tex_eff->SetTextSize(0.025);
   tex_eff->Draw();
   
   gROOT->ProcessLine(".x ./Sens_Matrix_LAr1ND_100m_T600_on_axis_Shape_and_Rate_5sigma_NoFlux_StatMatch.C(c3)");
   gROOT->ProcessLine(".x ./Sens_Matrix_LAr1ND_150m_T600_on_axis_Shape_and_Rate_5sigma_NoFlux_StatMatch.C(c3)");
   gROOT->ProcessLine(".x ./Sens_Matrix_LAr1ND_200m_T600_on_axis_Shape_and_Rate_5sigma_NoFlux_StatMatch.C(c3)");
