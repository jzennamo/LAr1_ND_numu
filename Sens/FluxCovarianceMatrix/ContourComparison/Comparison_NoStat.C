...
//=========  (Mon Jan  6 15:48:30 2014) by ROOT version5.34/05
   ...
   gROOT->ProcessLine(".x ./Sens_Matrix_LAr1ND_100m_No_Stat_T600_on_axis_Shape_and_Rate.C(c3)");
   gROOT->ProcessLine(".x ./Sens_Matrix_LAr1ND_150m_No_Stat_T600_on_axis_Shape_and_Rate.C(c3)");
   gROOT->ProcessLine(".x ./Sens_Matrix_LAr1ND_200m_No_Stat_T600_on_axis_Shape_and_Rate.C(c3)");
