...
//=========  (Mon Jan  6 15:48:30 2014) by ROOT version5.34/05
   ...
   hr1__1->GetXaxis()->SetTickLength(0.00);
   hr1__1->GetYaxis()->SetTickLength(0.00);
   hr1__1->GetXaxis()->SetLabelSize(0.0);
   hr1__1->GetXaxis()->SetTitleSize(0.05);
   hr1__1->GetXaxis()->SetTitleOffset(0.55);
   hr1__1->GetYaxis()->SetTitle("#Deltam_{41}^{2} [eV^{2}]");
   hr1__1->GetYaxis()->CenterTitle(true);
   hr1__1->GetYaxis()->SetLabelFont(62);
   hr1__1->GetYaxis()->SetLabelSize(0.0);
   hr1__1->GetYaxis()->SetTitleSize(0.05);
   hr1__1->GetYaxis()->SetTitleOffset(0.6);
   hr1__1->Draw("");
   ...
   TLatex *tex_pre = new TLatex(.12,.76,"PRELIMINARY");
   tex_pre->SetNDC();
   ...
   */
   ...
   TLatex *tex_un = new TLatex(.12,.86,"Statistical and Flux Uncert. Only");
   tex_un->SetNDC();
   ...
   gROOT->ProcessLine(".x ./Sens_Matrix_LAr1ND_100m_T600_on_axis_ShapeOnly_5sigma.C(c3)");
   gROOT->ProcessLine(".x ./Sens_Matrix_LAr1ND_150m_T600_on_axis_ShapeOnly_5sigma.C(c3)");
   gROOT->ProcessLine(".x ./Sens_Matrix_LAr1ND_200m_T600_on_axis_ShapeOnly_5sigma.C(c3)");

   TLegend *leg = new TLegend(0.12,0.12,0.4,0.3,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(62);
